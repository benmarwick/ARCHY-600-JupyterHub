...
RUN R -e "install.packages(c('tidyverse', 'broom', 'cowplot', 'ggbeeswarm', 'here', 'readxl', 'ggrepel', 'geomorph', 'Morpho', 'Momocs', 'EBImage', 'imager', 'sf', 'tabula', 'tesselle', 'dimensio'), repos='https://cran.rstudio.com')"
